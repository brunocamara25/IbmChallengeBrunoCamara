...
public class ResponseItem{
	...
	private ResponseItemLicense license;                                              
	...
	public ResponseItemOwner getOwner() {
		return owner;
	}
	public void setOwner(ResponseItemOwner owner) {
		this.owner = owner;
	}
	public ResponseItemLicense getLicense() {
		return license;
	}
	public void setLicense(ResponseItemLicense license) {
